...
<p style='color:#FFFFFF; margin-top: -55px; text-align: right;'>
    <?php
    if (isset($_SESSION["username"])) {
    ?>
        Xin chào <?php echo $_SESSION["username"]; ?>,<a href='<?php echo "http://localhost:8888/web/logout.php"; ?>'>Đăng xuất</a>
    <?php
    } else {
