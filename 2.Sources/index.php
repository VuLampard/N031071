    ...
    <div id="left">
        ...
        while ($data3 = mysqli_fetch_assoc($result3)) {
            ...
            echo "  <div class='category'>
                        <a href='category.php?id=$data3[cate_id]' ><h4>$data3[cate_title]</h4></a>
                    </div>";
            echo "<div class='article'>";
            $result = mysqli_query($conn, " select new_id,title,image,introduce 
                                            from news 
                                            where cate_id=$data3[cate_id] order by new_id DESC");
            ...
            echo "<ul>";
            $result2 = mysqli_query($conn, "select new_id,title 
                                            from news 
                                            where cate_id=$data3[cate_id] order by new_id desc limit 1,3");
